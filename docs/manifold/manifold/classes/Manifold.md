...
[manifold-3d](../../README.md) / [manifold](../README.md) / Manifold
...
Defined in: manifold-3d/manifold.d.ts:985

该操作会返回一个**拓扑上相互分离的流形向量**。
若所有物体都是连通的，则该向量长度为 1，仅包含原流形的一个副本。
此操作是 **Compose()** 的逆运算。
...
Defined in: manifold-3d/manifold.d.ts:975

根据一组其他流形构建新的流形。这是一个**纯拓扑操作**，因此应注意避免生成重叠的结果。该操作是 **Decompose()** 的逆运算。
...
Defined in: manifold-3d/manifold.d.ts:450

构建一个单位立方体（所有边长均为1），默认位于第一卦限，且与原点相接。
...
Defined in: manifold-3d/manifold.d.ts:466

这是一个用于**圆形拉伸**常见场景的便捷构造函数。
如果同时指定两个半径，还可以生成**圆锥体**。
...
Defined in: manifold-3d/manifold.d.ts:599

根据输入的**符号距离函数（SDF）**构建等值面网格。
该过程采用一种**四面体行进算法**（类似于立方体行进算法，但更适合生成流形结构）。它不使用立方体网格，而是采用**体心立方网格**（两组错位的立方体网格）。
这意味着如果你的函数内部区域超出了指定边界，你会看到类似蛋格的形状封闭住流形，这是由底层网格结构导致的。
...
Defined in: manifold-3d/manifold.d.ts:481
...
Defined in: manifold-3d/manifold.d.ts:440
...
Defined in: manifold-3d/manifold.d.ts:787
...
Defined in: manifold-3d/manifold.d.ts:806
...
Defined in: manifold-3d/manifold.d.ts:764
...
Defined in: manifold-3d/manifold.d.ts:431
...
Defined in: manifold-3d/manifold.d.ts:1166
...
Defined in: manifold-3d/manifold.d.ts:815
...
Defined in: manifold-3d/manifold.d.ts:829
...
Defined in: manifold-3d/manifold.d.ts:926
...
Defined in: manifold-3d/manifold.d.ts:917
...
Defined in: manifold-3d/manifold.d.ts:881
...
Defined in: manifold-3d/manifold.d.ts:894
...
Defined in: manifold-3d/manifold.d.ts:822
...
Defined in: manifold-3d/manifold.d.ts:908
...
Defined in: manifold-3d/manifold.d.ts:843
...
Defined in: manifold-3d/manifold.d.ts:864
...
Defined in: manifold-3d/manifold.d.ts:850
...
Defined in: manifold-3d/manifold.d.ts:871
...
Defined in: manifold-3d/manifold.d.ts:836
...
Defined in: manifold-3d/manifold.d.ts:857
...
Defined in: manifold-3d/manifold.d.ts:954
...
Defined in: manifold-3d/manifold.d.ts:962
...
readonly (`Manifold` \| [`Vec3`](../type-aliases/Vec3.md))[]
...
> **boundingBox**(): [`Box`](../type-aliases/Box.md)

Defined in: manifold-3d/manifold.d.ts:1031
...
Defined in: manifold-3d/manifold.d.ts:1069
...
Defined in: manifold-3d/manifold.d.ts:993
...
Defined in: manifold-3d/manifold.d.ts:1011
...
Defined in: manifold-3d/manifold.d.ts:1017
...
Defined in: manifold-3d/manifold.d.ts:1025
...
Defined in: manifold-3d/manifold.d.ts:1005
...
Defined in: manifold-3d/manifold.d.ts:999
...
> **status**(): [`ErrorStatus`](../type-aliases/ErrorStatus.md)

Defined in: manifold-3d/manifold.d.ts:1101
...
[`ErrorStatus`](../type-aliases/ErrorStatus.md)
...
Defined in: manifold-3d/manifold.d.ts:1042
...
Defined in: manifold-3d/manifold.d.ts:1120
...
Defined in: manifold-3d/manifold.d.ts:540
...
Defined in: manifold-3d/manifold.d.ts:1091
...
Defined in: manifold-3d/manifold.d.ts:1076
...
Defined in: manifold-3d/manifold.d.ts:1083
...
Defined in: manifold-3d/manifold.d.ts:1139
...
Defined in: manifold-3d/manifold.d.ts:1148
...
Defined in: manifold-3d/manifold.d.ts:1157
...
Defined in: manifold-3d/manifold.d.ts:945
...
Defined in: manifold-3d/manifold.d.ts:937
...
Defined in: manifold-3d/manifold.d.ts:504
...
[`CrossSection`](CrossSection.md) \| [`Polygons`](../type-aliases/Polygons.md)
...
Defined in: manifold-3d/manifold.d.ts:522
...
Defined in: manifold-3d/manifold.d.ts:722
...
Defined in: manifold-3d/manifold.d.ts:735
...
Defined in: manifold-3d/manifold.d.ts:750
...
Defined in: manifold-3d/manifold.d.ts:689
...
Defined in: manifold-3d/manifold.d.ts:709
...
Defined in: manifold-3d/manifold.d.ts:572
...
readonly [`Smoothness`](../type-aliases/Smoothness.md)[]
...
Defined in: manifold-3d/manifold.d.ts:664
...
Defined in: manifold-3d/manifold.d.ts:643
...
Defined in: manifold-3d/manifold.d.ts:644
...
Defined in: manifold-3d/manifold.d.ts:653
...
Defined in: manifold-3d/manifold.d.ts:1049
...
Defined in: manifold-3d/manifold.d.ts:1061
...
Defined in: manifold-3d/manifold.d.ts:613
...
Defined in: manifold-3d/manifold.d.ts:622
...
Defined in: manifold-3d/manifold.d.ts:623
...
Defined in: manifold-3d/manifold.d.ts:676
